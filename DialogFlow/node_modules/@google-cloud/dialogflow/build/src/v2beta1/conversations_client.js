...
class ConversationsClient {
    ...
    suggestConversationSummary(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                conversation: (_a = request.conversation) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    generateStatelessSummary(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'stateless_conversation.parent': (_a = request.statelessConversation.parent) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    searchKnowledge(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                parent: (_a = request.parent) !== null && _a !== void 0 ? _a : '',
                conversation: (_b = request.conversation) !== null && _b !== void 0 ? _b : '',
            });
        this.initialize();
